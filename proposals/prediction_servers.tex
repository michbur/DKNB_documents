...
\includepdf[scale=0.65,pagecommand=\section*{Oświadczenie kierownika Zakładu Genomiki}]{oswiadczenie1.pdf}

\includepdf[scale=0.65,pagecommand=\section*{Oświadczenie opiekuna Koła}]{osw_gagat.pdf}
